...
### Tipos de dados
Conhecer os tipos de dados usados pela linguagem é fundamental para manipulação e análise dos mesmos. A seguir os principais tipos de dados:
...
### Operadores
Existem inúmeras operações passíveis de serem realizadas com os dados e na lógicada programação. A seguir os principais operadores:
...
### Conversão de tipos
Por ser de tipagem dinâmica, podemos converter os tipos de dados:
...
A lógica da programação e a construção de algoritmos precisa das estruturas de controles:  
