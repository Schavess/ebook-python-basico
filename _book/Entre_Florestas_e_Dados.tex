...
\date{Última atualização: 2024-11-23}
...
\section{Arrays e Dataframes}\label{arrays-e-dataframes}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# Criando vetores de diferentes tipos}
\NormalTok{vetor\_numerico }\OtherTok{\textless{}{-}} \FunctionTok{c}\NormalTok{(}\DecValTok{1}\NormalTok{, }\DecValTok{2}\NormalTok{, }\DecValTok{3}\NormalTok{, }\DecValTok{4}\NormalTok{, }\DecValTok{5}\NormalTok{)}
\NormalTok{vetor\_caractere }\OtherTok{\textless{}{-}} \FunctionTok{c}\NormalTok{(}\StringTok{"Maçã"}\NormalTok{, }\StringTok{"Banana"}\NormalTok{, }\StringTok{"Laranja"}\NormalTok{, }\StringTok{"Goiaba"}\NormalTok{)}
...
\CommentTok{\# Visualizando os vetores}
\FunctionTok{print}\NormalTok{(vetor\_numerico)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{print}\NormalTok{(vetor\_caractere)}
\end{Highlighting}
\end{Shaded}

\begin{verbatim}
## [1] "Maçã"    "Banana"  "Laranja" "Goiaba"
\end{verbatim}

\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{print}\NormalTok{(vetor\_logico)}
\end{Highlighting}
\end{Shaded}
...
\FunctionTok{length}\NormalTok{(vetor\_numerico)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# Acessando o primeiro elemento do vetor}
\NormalTok{vetor\_caractere[}\DecValTok{1}\NormalTok{]}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# Acessando os 3 primeiros elementos}
\NormalTok{vetor\_caractere[}\DecValTok{1}\SpecialCharTok{:}\DecValTok{3}\NormalTok{]}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# Acessando uma lista de elementos}
\NormalTok{vetor\_caractere[}\FunctionTok{c}\NormalTok{(}\DecValTok{1}\NormalTok{,}\DecValTok{4}\NormalTok{)]}
\end{Highlighting}
\end{Shaded}
...
\subsection{Matrix (Array 2D)}\label{matrix-array-2d}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{a }\OtherTok{\textless{}{-}} \FunctionTok{seq}\NormalTok{(}\AttributeTok{from=}\DecValTok{1}\NormalTok{, }\AttributeTok{to=}\DecValTok{6}\NormalTok{)}
\NormalTok{b }\OtherTok{\textless{}{-}} \FunctionTok{seq}\NormalTok{(}\AttributeTok{from=}\DecValTok{1}\NormalTok{, }\AttributeTok{to=}\DecValTok{10}\NormalTok{)}

\CommentTok{\# Criando matrizes }
\NormalTok{A }\OtherTok{\textless{}{-}} \FunctionTok{matrix}\NormalTok{(a, }\AttributeTok{nrow =} \DecValTok{2}\NormalTok{, }\AttributeTok{ncol =} \DecValTok{3}\NormalTok{, }\AttributeTok{byrow =} \ConstantTok{TRUE}\NormalTok{) }
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{B }\OtherTok{\textless{}{-}} \FunctionTok{matrix}\NormalTok{(b, }\AttributeTok{nrow =} \DecValTok{5}\NormalTok{, }\AttributeTok{ncol =} \DecValTok{2}\NormalTok{, }\AttributeTok{byrow =} \ConstantTok{FALSE}\NormalTok{)}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# Acessando a segunda Coluna de B}
\FunctionTok{print}\NormalTok{(B[, }\DecValTok{2}\NormalTok{])}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# Acessando a primeira linha de A}
\FunctionTok{print}\NormalTok{(A[}\DecValTok{1}\NormalTok{,])}
\end{Highlighting}
\end{Shaded}
...
\subsubsection{Criando Arrays}\label{criando-arrays}

Para criar um array, usamos a função array().

\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# Criando um array 3x3x2}
\NormalTok{meu\_array }\OtherTok{\textless{}{-}} \FunctionTok{array}\NormalTok{(}\AttributeTok{data =} \DecValTok{1}\SpecialCharTok{:}\DecValTok{18}\NormalTok{, }\AttributeTok{dim =} \FunctionTok{c}\NormalTok{(}\DecValTok{3}\NormalTok{, }\DecValTok{3}\NormalTok{, }\DecValTok{2}\NormalTok{))}

\CommentTok{\# Visualizando o array}
...
\subsubsection{Acessando elementos}\label{acessando-elementos}

Os elementos em arrays podem ser acessados usando índices.

\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# Acessar o elemento na posição [1, 2, 1]}
\NormalTok{meu\_array[}\DecValTok{1}\NormalTok{, }\DecValTok{2}\NormalTok{, }\DecValTok{1}\NormalTok{]}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# Acessar a segunda camada inteira}
\NormalTok{meu\_array[, , }\DecValTok{2}\NormalTok{]}
\end{Highlighting}
\end{Shaded}
...
\subsubsection{Criando Dataframes}\label{criando-dataframes}

\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# Criando um dataframe}
\NormalTok{meu\_dataframe }\OtherTok{\textless{}{-}} \FunctionTok{data.frame}\NormalTok{(}
  \AttributeTok{Nome =} \FunctionTok{c}\NormalTok{(}\StringTok{"João"}\NormalTok{, }\StringTok{"Ana"}\NormalTok{, }\StringTok{"Carlos"}\NormalTok{),}
  \AttributeTok{Idade =} \FunctionTok{c}\NormalTok{(}\DecValTok{25}\NormalTok{, }\DecValTok{30}\NormalTok{, }\DecValTok{22}\NormalTok{),}
  \AttributeTok{Altura =} \FunctionTok{c}\NormalTok{(}\FloatTok{1.75}\NormalTok{, }\FloatTok{1.68}\NormalTok{, }\FloatTok{1.80}\NormalTok{)}
\NormalTok{)}

\CommentTok{\# Visualizando o dataframe}
\FunctionTok{print}\NormalTok{(meu\_dataframe)}
\end{Highlighting}
\end{Shaded}
...
\subsubsection{Acessando elementos}\label{acessando-elementos-1}

Você pode acessar linhas, colunas ou células específicas de um dataframe.

\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# Acessar a coluna "Idade"}
\NormalTok{meu\_dataframe}\SpecialCharTok{$}\NormalTok{Idade}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# Acessar a primeira linha}
\NormalTok{meu\_dataframe[}\DecValTok{1}\NormalTok{, ]}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# Acessar um elemento específico (linha 2, coluna 3)}
\NormalTok{meu\_dataframe[}\DecValTok{2}\NormalTok{, }\DecValTok{3}\NormalTok{]}
\end{Highlighting}
\end{Shaded}
...
\subsubsection{Criando ou Removendo uma coluna}\label{criando-ou-removendo-uma-coluna}

\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# Adicionar uma nova coluna}
\NormalTok{meu\_dataframe}\SpecialCharTok{$}\NormalTok{Peso }\OtherTok{\textless{}{-}} \FunctionTok{c}\NormalTok{(}\DecValTok{70}\NormalTok{, }\DecValTok{60}\NormalTok{, }\DecValTok{80}\NormalTok{)}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# Remover a coluna "Peso"}
\NormalTok{meu\_dataframe}\SpecialCharTok{$}\NormalTok{Peso }\OtherTok{\textless{}{-}} \ConstantTok{NULL}
...
\NormalTok{minha\_lista }\OtherTok{\textless{}{-}} \FunctionTok{list}\NormalTok{(}
  \AttributeTok{numeros =} \FunctionTok{c}\NormalTok{(}\DecValTok{1}\NormalTok{, }\DecValTok{2}\NormalTok{, }\DecValTok{3}\NormalTok{),}
  \AttributeTok{nomes =} \FunctionTok{c}\NormalTok{(}\StringTok{"Alice"}\NormalTok{, }\StringTok{"Bob"}\NormalTok{, }\StringTok{"Carol"}\NormalTok{),}
  \AttributeTok{dataframe =}\NormalTok{ meu\_dataframe}
\NormalTok{)}
...
\subsection{Acessando Elementos de Listas}\label{acessando-elementos-de-listas}

Os elementos de uma lista podem ser acessados por índices ou nomes.

\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# Acessar o primeiro elemento}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# Acessar pelo nome}
\NormalTok{minha\_lista}\SpecialCharTok{$}\NormalTok{numeros}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# Acessar elementos dentro de um dataframe armazenado}
\NormalTok{minha\_lista}\SpecialCharTok{$}\NormalTok{dataframe}\SpecialCharTok{$}\NormalTok{Idade}
\end{Highlighting}
\end{Shaded}
...
\subsection{Dataframe vs.~Lista}\label{dataframe-vs.-lista}
...
\bottomrule\noalign{}
\endlastfoot
\textbf{Estrutura} & Tabela (linhas e colunas) & Estrutura hierárquica \\
\textbf{Tipos de dados} & Colunas podem ter tipos diferentes & Elementos podem ser de qualquer tipo, incluindo listas ou dataframes \\
\textbf{Indexação} & Por linhas e colunas & Por índices ou nomes \\
\textbf{Uso típico} & Dados tabulares & Agrupamento de objetos heterogêneos \\
\end{longtable}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# Função simples para calcular a soma de dois números}
...
\CommentTok{\# Usando a função}
\FunctionTok{soma}\NormalTok{(}\DecValTok{2}\NormalTok{, }\DecValTok{3}\NormalTok{)  }\CommentTok{\# Resultado: 5}
\end{Highlighting}
\end{Shaded}
...
\subsection{Usando funções}\label{usando-funuxe7uxf5es}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# Funções básicas}
\FunctionTok{sqrt}\NormalTok{(}\DecValTok{16}\NormalTok{)      }\CommentTok{\# Raiz quadrada: 4}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{round}\NormalTok{(}\FloatTok{3.1415}\NormalTok{, }\DecValTok{2}\NormalTok{)  }\CommentTok{\# Arredondar para 2 casas decimais: 3.14}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{dados }\OtherTok{\textless{}{-}} \FunctionTok{c}\NormalTok{(}\DecValTok{1}\NormalTok{, }\DecValTok{2}\NormalTok{, }\DecValTok{3}\NormalTok{, }\DecValTok{4}\NormalTok{, }\DecValTok{5}\NormalTok{)}

\CommentTok{\# Estatísticas básicas}
\FunctionTok{mean}\NormalTok{(dados)   }\CommentTok{\# Média: 3}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{median}\NormalTok{(dados) }\CommentTok{\# Mediana: 3}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{sd}\NormalTok{(dados)     }\CommentTok{\# Desvio padrão}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# Manipulando texto}
\NormalTok{texto }\OtherTok{\textless{}{-}} \StringTok{"Programar no R é divertido!"}
\FunctionTok{nchar}\NormalTok{(texto)       }\CommentTok{\# Número de caracteres: 27}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{toupper}\NormalTok{(texto)     }\CommentTok{\# Tudo maiúsculo}
\end{Highlighting}
\end{Shaded}

\begin{verbatim}
## [1] "PROGRAMAR NO R É DIVERTIDO!"
\end{verbatim}

\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{tolower}\NormalTok{(texto)     }\CommentTok{\# Tudo minúsculo}
\end{Highlighting}
\end{Shaded}
...
\subsection{Criando funções}\label{criando-funuxe7uxf5es}

Estrutura:

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{nome\_da\_funcao }\OtherTok{\textless{}{-}} \ControlFlowTok{function}\NormalTok{(argumento1, argumento2, ...) \{}
  \CommentTok{\# Corpo da função (o que será feito)}
\NormalTok{  resultado }\OtherTok{\textless{}{-}}\NormalTok{ argumento1 }\SpecialCharTok{+}\NormalTok{ argumento2  }\CommentTok{\# Exemplo}
  \FunctionTok{return}\NormalTok{(resultado)  }\CommentTok{\# O que será retornado}
\NormalTok{\}}
\end{Highlighting}
\end{Shaded}
...
\subsubsection{Função com 1 argumentos}\label{funuxe7uxe3o-com-1-argumentos}

\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# Função quadrado (1 argumento)}
...
\FunctionTok{quadrado}\NormalTok{(}\DecValTok{4}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\subsubsection{Função com dois argumentos}\label{funuxe7uxe3o-com-dois-argumentos}

\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# Calcula o volume de um cilindro (2 argumentos)}
\NormalTok{volume\_cilindro }\OtherTok{\textless{}{-}} \ControlFlowTok{function}\NormalTok{(raio, altura) \{}
\NormalTok{  volume }\OtherTok{\textless{}{-}}\NormalTok{ pi }\SpecialCharTok{*}\NormalTok{ raio}\SpecialCharTok{\^{}}\DecValTok{2} \SpecialCharTok{*}\NormalTok{ altura}
  \FunctionTok{return}\NormalTok{(volume)}
\NormalTok{\}}

\CommentTok{\# Usando a função com os argumentos}
\FunctionTok{volume\_cilindro}\NormalTok{(}\AttributeTok{raio =} \DecValTok{3}\NormalTok{, }\AttributeTok{altura =} \DecValTok{5}\NormalTok{)  }\CommentTok{\# Resultado: 141.37}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# ou usando a função pela ordem dos argumentos}
\FunctionTok{volume\_cilindro}\NormalTok{(}\DecValTok{3}\NormalTok{, }\DecValTok{5}\NormalTok{)  }\CommentTok{\# Resultado: 141.37}
\end{Highlighting}
\end{Shaded}
...
\subsection{Argumentos padrão (default)}\label{argumentos-padruxe3o-default}

Você pode definir valores padrão para os argumentos, tornando-os opcionais ao chamar a função.

\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# Função com argumento padrão}
\NormalTok{saudacao }\OtherTok{\textless{}{-}} \ControlFlowTok{function}\NormalTok{(}\AttributeTok{nome =} \StringTok{"Visitante"}\NormalTok{) \{}
  \FunctionTok{return}\NormalTok{(}\FunctionTok{paste}\NormalTok{(}\StringTok{"Olá,"}\NormalTok{, nome, }\StringTok{"!"}\NormalTok{))}
\NormalTok{\}}

\CommentTok{\# Chamadas da função}
\FunctionTok{saudacao}\NormalTok{(}\StringTok{"Maria"}\NormalTok{)  }\CommentTok{\# Resultado: "Olá, Maria !"}
\FunctionTok{saudacao}\NormalTok{()         }\CommentTok{\# Resultado: "Olá, Visitante !"}
\end{Highlighting}
\end{Shaded}

\subsection{Função anônima}\label{funuxe7uxe3o-anuxf4nima}

A função será executada somente naquele instante; não havendo necessidade de se nomeá-la. No javascript são conhecidas como \emph{arrow functions}.

\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# Função anônima em apply()}
\NormalTok{vetor }\OtherTok{\textless{}{-}} \FunctionTok{c}\NormalTok{(}\DecValTok{1}\NormalTok{, }\DecValTok{2}\NormalTok{, }\DecValTok{3}\NormalTok{, }\DecValTok{4}\NormalTok{)}
\NormalTok{resultado }\OtherTok{\textless{}{-}} \FunctionTok{sapply}\NormalTok{(vetor, }\ControlFlowTok{function}\NormalTok{(x) x}\SpecialCharTok{\^{}}\DecValTok{2}\NormalTok{)}

\FunctionTok{print}\NormalTok{(resultado)  }\CommentTok{\# Resultado: [1]  1  4  9 16}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# Exemplo de gráfico de dispersão}
...
\FunctionTok{plot}\NormalTok{(x, y, }\AttributeTok{main =} \StringTok{"Gráfico de Dispersão"}\NormalTok{, }\AttributeTok{xlab =} \StringTok{"Eixo X"}\NormalTok{, }\AttributeTok{ylab =} \StringTok{"Eixo Y"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\includegraphics{Entre_Florestas_e_Dados_files/figure-latex/unnamed-chunk-42-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# Exemplo de histograma}
\NormalTok{dados }\OtherTok{\textless{}{-}} \FunctionTok{rnorm}\NormalTok{(}\DecValTok{1000}\NormalTok{)}
\FunctionTok{hist}\NormalTok{(dados, }\AttributeTok{main =} \StringTok{"Histograma"}\NormalTok{, }\AttributeTok{xlab =} \StringTok{"Valores"}\NormalTok{, }\AttributeTok{col =} \StringTok{"lightblue"}\NormalTok{, }\AttributeTok{border =} \StringTok{"black"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\includegraphics{Entre_Florestas_e_Dados_files/figure-latex/unnamed-chunk-43-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# Exemplo de boxplot}
\NormalTok{grupo }\OtherTok{\textless{}{-}} \FunctionTok{factor}\NormalTok{(}\FunctionTok{rep}\NormalTok{(}\FunctionTok{c}\NormalTok{(}\StringTok{"A"}\NormalTok{, }\StringTok{"B"}\NormalTok{), }\AttributeTok{each =} \DecValTok{50}\NormalTok{))}
\NormalTok{valores }\OtherTok{\textless{}{-}} \FunctionTok{c}\NormalTok{(}\FunctionTok{rnorm}\NormalTok{(}\DecValTok{50}\NormalTok{, }\AttributeTok{mean =} \DecValTok{5}\NormalTok{), }\FunctionTok{rnorm}\NormalTok{(}\DecValTok{50}\NormalTok{, }\AttributeTok{mean =} \DecValTok{7}\NormalTok{))}
\FunctionTok{boxplot}\NormalTok{(valores }\SpecialCharTok{\textasciitilde{}}\NormalTok{ grupo, }\AttributeTok{main =} \StringTok{"Boxplot por Grupo"}\NormalTok{, }\AttributeTok{col =} \FunctionTok{c}\NormalTok{(}\StringTok{"orange"}\NormalTok{, }\StringTok{"lightgreen"}\NormalTok{))}
\end{Highlighting}
\end{Shaded}

\includegraphics{Entre_Florestas_e_Dados_files/figure-latex/unnamed-chunk-44-1.pdf}

\subsection{Gráficos de pizza}\label{gruxe1ficos-de-pizza}

Embora não seja o preferido para análise quantitativa, o gráfico de pizza é útil para exibir proporções.

\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# Exemplo de gráfico de pizza}
\NormalTok{valores }\OtherTok{\textless{}{-}} \FunctionTok{c}\NormalTok{(}\DecValTok{40}\NormalTok{, }\DecValTok{25}\NormalTok{, }\DecValTok{20}\NormalTok{, }\DecValTok{15}\NormalTok{)}
\NormalTok{categorias }\OtherTok{\textless{}{-}} \FunctionTok{c}\NormalTok{(}\StringTok{"Categoria A"}\NormalTok{, }\StringTok{"Categoria B"}\NormalTok{, }\StringTok{"Categoria C"}\NormalTok{, }\StringTok{"Categoria D"}\NormalTok{)}
\FunctionTok{pie}\NormalTok{(valores, }\AttributeTok{labels =}\NormalTok{ categorias, }
    \AttributeTok{main =} \StringTok{"Gráfico de Pizza"}\NormalTok{, }
    \AttributeTok{col =} \FunctionTok{c}\NormalTok{(}\StringTok{"red"}\NormalTok{, }\StringTok{"blue"}\NormalTok{, }\StringTok{"green"}\NormalTok{, }\StringTok{"yellow"}\NormalTok{))}
\end{Highlighting}
\end{Shaded}

\includegraphics{Entre_Florestas_e_Dados_files/figure-latex/unnamed-chunk-45-1.pdf}

\subsection{Personalização dos gráficos}\label{personalizauxe7uxe3o-dos-gruxe1ficos}
...
\FunctionTok{plot}\NormalTok{(x, y, }
     \AttributeTok{main =} \StringTok{"Gráfico Personalizado"}\NormalTok{,}
...
\includegraphics{Entre_Florestas_e_Dados_files/figure-latex/unnamed-chunk-46-1.pdf}

\chapter{R Intermediário}\label{r-intermediuxe1rio}
...
\tightlist
\item
  Funções da família \texttt{apply()};
\item
  O pacote \texttt{dplyr};
\item
  O pacote \texttt{data.table}.
\item
  O pacote gráfico \texttt{lattice}
\end{enumerate}
...
\subsection{\texorpdfstring{O que é o Pipe \texttt{\%\textgreater{}\%}?}{O que é o Pipe \%\textgreater\%?}}\label{o-que-uxe9-o-pipe}
...
\subsubsection{Exemplos de Uso}\label{exemplos-de-uso}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# Criando um exemplo de dados florestais}
\FunctionTok{library}\NormalTok{(dplyr)}

\NormalTok{dados\_florestais }\OtherTok{\textless{}{-}}\NormalTok{ tibble}\SpecialCharTok{::}\FunctionTok{tibble}\NormalTok{(}
  \AttributeTok{parcela =} \FunctionTok{rep}\NormalTok{(}\DecValTok{1}\SpecialCharTok{:}\DecValTok{5}\NormalTok{, }\AttributeTok{each =} \DecValTok{10}\NormalTok{),}
  \AttributeTok{especie =} \FunctionTok{sample}\NormalTok{(}\FunctionTok{c}\NormalTok{(}\StringTok{"Cedro"}\NormalTok{, }\StringTok{"Ipê"}\NormalTok{, }\StringTok{"Jatobá"}\NormalTok{, }\StringTok{"Angelim"}\NormalTok{, }\StringTok{"Castanheira"}\NormalTok{), }\DecValTok{50}\NormalTok{, }\AttributeTok{replace =} \ConstantTok{TRUE}\NormalTok{),}
  \AttributeTok{dap\_cm =} \FunctionTok{round}\NormalTok{(}\FunctionTok{runif}\NormalTok{(}\DecValTok{50}\NormalTok{, }\DecValTok{10}\NormalTok{, }\DecValTok{80}\NormalTok{), }\DecValTok{1}\NormalTok{),  }\CommentTok{\# Diâmetro em cm}
  \AttributeTok{altura\_m =} \FunctionTok{round}\NormalTok{(}\FunctionTok{runif}\NormalTok{(}\DecValTok{50}\NormalTok{, }\DecValTok{5}\NormalTok{, }\DecValTok{30}\NormalTok{), }\DecValTok{1}\NormalTok{),  }\CommentTok{\# Altura em metros}
  \AttributeTok{volume\_m3 =}\NormalTok{ dap\_cm }\SpecialCharTok{*}\NormalTok{ altura\_m }\SpecialCharTok{*} \FloatTok{0.00007854} \CommentTok{\# Fórmula fictícia para volume}
\NormalTok{)}

\NormalTok{dados\_florestais}
\end{Highlighting}
\end{Shaded}
...
##      <int> <chr>        <dbl>    <dbl>     <dbl>
##  1       1 Cedro         19.4     14.8    0.0226
##  2       1 Castanheira   23.3     10.3    0.0188
##  3       1 Ipê           25.1     23.8    0.0469
##  4       1 Cedro         75.4     16.1    0.0953
##  5       1 Angelim       79.2     16.3    0.101 
##  6       1 Cedro         31.7      7.1    0.0177
##  7       1 Castanheira   19.6     14.1    0.0217
##  8       1 Ipê           56.3     27.4    0.121 
##  9       1 Castanheira   50.9     18.6    0.0744
## 10       1 Cedro         34.1      5.8    0.0155
## # i 40 more rows
\end{verbatim}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# Filtrando árvores com DAP \textgreater{} 50 cm}
\NormalTok{arvores\_grandes }\OtherTok{\textless{}{-}}\NormalTok{ dados\_florestais }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{filter}\NormalTok{(dap\_cm }\SpecialCharTok{\textgreater{}} \DecValTok{50}\NormalTok{)}

\FunctionTok{head}\NormalTok{(arvores\_grandes)}
\end{Highlighting}
\end{Shaded}
...
##   parcela especie     dap_cm altura_m volume_m3
##     <int> <chr>        <dbl>    <dbl>     <dbl>
## 1       1 Cedro         75.4     16.1    0.0953
## 2       1 Angelim       79.2     16.3    0.101 
## 3       1 Ipê           56.3     27.4    0.121 
## 4       1 Castanheira   50.9     18.6    0.0744
## 5       2 Castanheira   67       14.7    0.0774
## 6       2 Cedro         69.2     11.9    0.0647
\end{verbatim}

\subsection{select()}\label{select}

Para trabalhar com um subconjunto de variáveis, podemos usar select(). Exemplo: selecionar apenas as colunas especie, dap\_cm e altura\_m.

\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# Selecionando colunas específicas}
\NormalTok{dados\_selecionados }\OtherTok{\textless{}{-}}\NormalTok{ dados\_florestais }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{select}\NormalTok{(especie, dap\_cm, altura\_m)}

\FunctionTok{head}\NormalTok{(dados\_selecionados)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# Adicionando o índice de esbeltez}
\NormalTok{dados\_florestais }\OtherTok{\textless{}{-}}\NormalTok{ dados\_florestais }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{mutate}\NormalTok{(}\AttributeTok{indice\_esbeltez =}\NormalTok{ altura\_m }\SpecialCharTok{/}\NormalTok{ dap\_cm)}

\FunctionTok{head}\NormalTok{(dados\_florestais)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# Ordenando por DAP}
\NormalTok{dados\_ordenados }\OtherTok{\textless{}{-}}\NormalTok{ dados\_florestais }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{arrange}\NormalTok{(}\FunctionTok{desc}\NormalTok{(dap\_cm))}

\FunctionTok{head}\NormalTok{(dados\_ordenados)}
\end{Highlighting}
\end{Shaded}
...
##   parcela especie dap_cm altura_m volume_m3
##     <int> <chr>    <dbl>    <dbl>     <dbl>
## 1       1 Angelim   79.2     16.3    0.101 
## 2       3 Jatobá    78.8     29      0.179 
## 3       5 Jatobá    76.7     21.1    0.127 
## 4       5 Jatobá    76.5     22.3    0.134 
## 5       2 Ipê       76        9.3    0.0555
## 6       1 Cedro     75.4     16.1    0.0953
## # i 1 more variable: indice_esbeltez <dbl>
\end{verbatim}

\subsection{summarise() e group\_by()}\label{summarise-e-group_by}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# Resumo por espécie}
\NormalTok{resumo\_especies }\OtherTok{\textless{}{-}}\NormalTok{ dados\_florestais }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{group\_by}\NormalTok{(especie) }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{summarise}\NormalTok{(}
    \AttributeTok{dap\_medio =} \FunctionTok{mean}\NormalTok{(dap\_cm),}
    \AttributeTok{volume\_total =} \FunctionTok{sum}\NormalTok{(volume\_m3)}
\NormalTok{  )}

\NormalTok{resumo\_especies}
\end{Highlighting}
\end{Shaded}
...
##   <chr>           <dbl>        <dbl>
## 1 Angelim          48.3        0.462
## 2 Castanheira      37.2        0.605
## 3 Cedro            51.6        0.755
## 4 Ipê              47.5        0.868
## 5 Jatobá           53.6        0.845
\end{verbatim}
...
Após usar group\_by() em uma análise, o objeto resultante permanece ``agrupado''. Isso pode afetar operações subsequentes. Para remover o agrupamento, usamos ungroup().
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# Resumo por espécie com agrupamento}
\NormalTok{resumo\_especies }\OtherTok{\textless{}{-}}\NormalTok{ dados\_florestais }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{group\_by}\NormalTok{(especie) }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{summarise}\NormalTok{(}\AttributeTok{dap\_medio =} \FunctionTok{mean}\NormalTok{(dap\_cm))}

\CommentTok{\# Adicionando o DAP médio geral}
\NormalTok{dap\_geral }\OtherTok{\textless{}{-}}\NormalTok{ resumo\_especies }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{ungroup}\NormalTok{() }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{summarise}\NormalTok{(}\AttributeTok{dap\_medio\_geral =} \FunctionTok{mean}\NormalTok{(dap\_medio))}

\NormalTok{dap\_geral}
\end{Highlighting}
\end{Shaded}
...
\subsection{\texorpdfstring{O que é o \texttt{:=}?}{O que é o :=?}}\label{o-que-uxe9-o}
...
\section{\texorpdfstring{Pacote \texttt{lattice}}{Pacote lattice}}\label{pacote-lattice}
...
\subsection{Dispersão condicional}\label{dispersuxe3o-condicional}
...
\NormalTok{dados }\OtherTok{\textless{}{-}} \FunctionTok{data.frame}\NormalTok{(}
  \AttributeTok{Parcela =} \FunctionTok{factor}\NormalTok{(}\FunctionTok{rep}\NormalTok{(}\DecValTok{1}\SpecialCharTok{:}\DecValTok{3}\NormalTok{, }\AttributeTok{each =} \DecValTok{50}\NormalTok{)),}
  \AttributeTok{DAP =} \FunctionTok{c}\NormalTok{(}\FunctionTok{rnorm}\NormalTok{(}\DecValTok{50}\NormalTok{, }\AttributeTok{mean =} \DecValTok{20}\NormalTok{, }\AttributeTok{sd =} \DecValTok{5}\NormalTok{), }
          \FunctionTok{rnorm}\NormalTok{(}\DecValTok{50}\NormalTok{, }\AttributeTok{mean =} \DecValTok{25}\NormalTok{, }\AttributeTok{sd =} \DecValTok{6}\NormalTok{), }
          \FunctionTok{rnorm}\NormalTok{(}\DecValTok{50}\NormalTok{, }\AttributeTok{mean =} \DecValTok{22}\NormalTok{, }\AttributeTok{sd =} \DecValTok{4}\NormalTok{)),}
  \AttributeTok{Altura =} \FunctionTok{c}\NormalTok{(}\FunctionTok{rnorm}\NormalTok{(}\DecValTok{50}\NormalTok{, }\AttributeTok{mean =} \DecValTok{15}\NormalTok{, }\AttributeTok{sd =} \DecValTok{3}\NormalTok{), }
             \FunctionTok{rnorm}\NormalTok{(}\DecValTok{50}\NormalTok{, }\AttributeTok{mean =} \DecValTok{18}\NormalTok{, }\AttributeTok{sd =} \DecValTok{2}\NormalTok{), }
             \FunctionTok{rnorm}\NormalTok{(}\DecValTok{50}\NormalTok{, }\AttributeTok{mean =} \DecValTok{16}\NormalTok{, }\AttributeTok{sd =} \DecValTok{3}\NormalTok{))}
\NormalTok{)}

\CommentTok{\# Gráfico de dispersão por parcela}
\FunctionTok{xyplot}\NormalTok{(Altura }\SpecialCharTok{\textasciitilde{}}\NormalTok{ DAP }\SpecialCharTok{|}\NormalTok{ Parcela, }\AttributeTok{data =}\NormalTok{ dados,}
       \AttributeTok{main =} \StringTok{"Altura x DAP por Parcela"}\NormalTok{,}
       \AttributeTok{xlab =} \StringTok{"Diâmetro à Altura do Peito (DAP)"}\NormalTok{,}
...
\includegraphics{Entre_Florestas_e_Dados_files/figure-latex/unnamed-chunk-61-1.pdf}

\subsection{Histograma condicional}\label{histograma-condicional}
...
\begin{Highlighting}[]
\CommentTok{\# Dados simulados}
\NormalTok{dados}\SpecialCharTok{$}\NormalTok{Especie }\OtherTok{\textless{}{-}} \FunctionTok{factor}\NormalTok{(}\FunctionTok{rep}\NormalTok{(}\FunctionTok{c}\NormalTok{(}\StringTok{"Espécie A"}\NormalTok{, }\StringTok{"Espécie B"}\NormalTok{, }\StringTok{"Espécie C"}\NormalTok{), }\AttributeTok{each =} \DecValTok{50}\NormalTok{))}

\CommentTok{\# Histograma por espécie}
\FunctionTok{histogram}\NormalTok{(}\SpecialCharTok{\textasciitilde{}}\NormalTok{ DAP }\SpecialCharTok{|}\NormalTok{ Especie, }\AttributeTok{data =}\NormalTok{ dados,}
          \AttributeTok{main =} \StringTok{"Distribuição do DAP por Espécie"}\NormalTok{,}
          \AttributeTok{xlab =} \StringTok{"Diâmetro à Altura do Peito (DAP)"}\NormalTok{,}
          \AttributeTok{col =} \StringTok{"lightblue"}\NormalTok{, }\AttributeTok{border =} \StringTok{"black"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\includegraphics{Entre_Florestas_e_Dados_files/figure-latex/unnamed-chunk-62-1.pdf}

\subsection{Boxplot comparativo}\label{boxplot-comparativo}

Os boxplots são ideais para comparar a altura das árvores entre espécies em diferentes parcelas.

\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# Ajustando o boxplot}
\FunctionTok{bwplot}\NormalTok{(Altura }\SpecialCharTok{\textasciitilde{}}\NormalTok{ Especie }\SpecialCharTok{|}\NormalTok{ Parcela, }\AttributeTok{data =}\NormalTok{ dados,}
       \AttributeTok{main =} \StringTok{"Altura por Espécie e Parcela"}\NormalTok{,}
       \AttributeTok{xlab =} \StringTok{"Espécie"}\NormalTok{, }\AttributeTok{ylab =} \StringTok{"Altura (m)"}\NormalTok{,}
       \AttributeTok{col =} \StringTok{"forestgreen"}\NormalTok{,}
       \AttributeTok{par.settings =} \FunctionTok{list}\NormalTok{(}\AttributeTok{box.rectangle =} \FunctionTok{list}\NormalTok{(}\AttributeTok{col =} \StringTok{"blue"}\NormalTok{),}
                           \AttributeTok{plot.symbol =} \FunctionTok{list}\NormalTok{(}\AttributeTok{col =} \StringTok{"darkgreen"}\NormalTok{, }\AttributeTok{pch =} \DecValTok{16}\NormalTok{)),}
       \AttributeTok{scales =} \FunctionTok{list}\NormalTok{(}\AttributeTok{x =} \FunctionTok{list}\NormalTok{(}\AttributeTok{rot =} \DecValTok{45}\NormalTok{))) }\CommentTok{\# Rotação dos rótulos no eixo X}
\end{Highlighting}
\end{Shaded}

\includegraphics{Entre_Florestas_e_Dados_files/figure-latex/unnamed-chunk-63-1.pdf}

\subsection{Barras por classes}\label{barras-por-classes}

Se quisermos visualizar a contagem de árvores por espécie em cada parcela, o gráfico de barras é uma escolha apropriada.

\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# Reorganizando os dados para melhor visualização}
\FunctionTok{library}\NormalTok{(reshape2)}
\NormalTok{dados\_barras }\OtherTok{\textless{}{-}} \FunctionTok{as.data.frame}\NormalTok{(contagem)}
\FunctionTok{names}\NormalTok{(dados\_barras) }\OtherTok{\textless{}{-}} \FunctionTok{c}\NormalTok{(}\StringTok{"Especie"}\NormalTok{, }\StringTok{"Parcela"}\NormalTok{, }\StringTok{"Contagem"}\NormalTok{)}

\CommentTok{\# Gráfico de barras mais visual}
\FunctionTok{barchart}\NormalTok{(Contagem }\SpecialCharTok{\textasciitilde{}}\NormalTok{ Especie }\SpecialCharTok{|}\NormalTok{ Parcela, }\AttributeTok{data =}\NormalTok{ dados\_barras,}
         \AttributeTok{main =} \StringTok{"Número de Árvores por Espécie e Parcela"}\NormalTok{,}
         \AttributeTok{xlab =} \StringTok{"Espécie"}\NormalTok{, }\AttributeTok{ylab =} \StringTok{"Número de Árvores"}\NormalTok{,}
         \AttributeTok{col =} \FunctionTok{c}\NormalTok{(}\StringTok{"darkgreen"}\NormalTok{, }\StringTok{"lightgreen"}\NormalTok{, }\StringTok{"brown"}\NormalTok{),}
         \AttributeTok{auto.key =} \FunctionTok{list}\NormalTok{(}\AttributeTok{columns =} \DecValTok{3}\NormalTok{), }\CommentTok{\# Legenda com as espécies}
         \AttributeTok{panel =} \ControlFlowTok{function}\NormalTok{(x, y, ...) \{}
           \FunctionTok{panel.barchart}\NormalTok{(x, y, ...)}
           \FunctionTok{panel.text}\NormalTok{(x, y, }\AttributeTok{labels =}\NormalTok{ y, }\AttributeTok{pos =} \DecValTok{3}\NormalTok{, }\AttributeTok{cex =} \FloatTok{0.8}\NormalTok{) }\CommentTok{\# Rótulos numéricos}
\NormalTok{         \},}
         \AttributeTok{scales =} \FunctionTok{list}\NormalTok{(}\AttributeTok{x =} \FunctionTok{list}\NormalTok{(}\AttributeTok{rot =} \DecValTok{45}\NormalTok{))) }\CommentTok{\# Rotação dos rótulos no eixo X}
\end{Highlighting}
\end{Shaded}

\includegraphics{Entre_Florestas_e_Dados_files/figure-latex/unnamed-chunk-64-1.pdf}
...
\FunctionTok{set.seed}\NormalTok{(}\DecValTok{123}\NormalTok{)}
\NormalTok{dados }\OtherTok{\textless{}{-}} \FunctionTok{data.frame}\NormalTok{(}
  \AttributeTok{Parcela =} \FunctionTok{factor}\NormalTok{(}\FunctionTok{rep}\NormalTok{(}\DecValTok{1}\SpecialCharTok{:}\DecValTok{3}\NormalTok{, }\AttributeTok{each =} \DecValTok{50}\NormalTok{)),  }\CommentTok{\# Três parcelas}
  \AttributeTok{DAP =} \FunctionTok{c}\NormalTok{(}\FunctionTok{rnorm}\NormalTok{(}\DecValTok{50}\NormalTok{, }\AttributeTok{mean =} \DecValTok{20}\NormalTok{, }\AttributeTok{sd =} \DecValTok{5}\NormalTok{), }
          \FunctionTok{rnorm}\NormalTok{(}\DecValTok{50}\NormalTok{, }\AttributeTok{mean =} \DecValTok{25}\NormalTok{, }\AttributeTok{sd =} \DecValTok{4}\NormalTok{), }
          \FunctionTok{rnorm}\NormalTok{(}\DecValTok{50}\NormalTok{, }\AttributeTok{mean =} \DecValTok{30}\NormalTok{, }\AttributeTok{sd =} \DecValTok{6}\NormalTok{)),  }\CommentTok{\# Diâmetro}
  \AttributeTok{Altura =} \FunctionTok{c}\NormalTok{(}\FunctionTok{rnorm}\NormalTok{(}\DecValTok{50}\NormalTok{, }\AttributeTok{mean =} \DecValTok{15}\NormalTok{, }\AttributeTok{sd =} \DecValTok{3}\NormalTok{), }
             \FunctionTok{rnorm}\NormalTok{(}\DecValTok{50}\NormalTok{, }\AttributeTok{mean =} \DecValTok{18}\NormalTok{, }\AttributeTok{sd =} \DecValTok{2}\NormalTok{), }
             \FunctionTok{rnorm}\NormalTok{(}\DecValTok{50}\NormalTok{, }\AttributeTok{mean =} \DecValTok{20}\NormalTok{, }\AttributeTok{sd =} \DecValTok{4}\NormalTok{)), }\CommentTok{\# Altura}
  \AttributeTok{Biomassa =} \FunctionTok{c}\NormalTok{(}\FunctionTok{rnorm}\NormalTok{(}\DecValTok{50}\NormalTok{, }\AttributeTok{mean =} \DecValTok{200}\NormalTok{, }\AttributeTok{sd =} \DecValTok{50}\NormalTok{), }
               \FunctionTok{rnorm}\NormalTok{(}\DecValTok{50}\NormalTok{, }\AttributeTok{mean =} \DecValTok{300}\NormalTok{, }\AttributeTok{sd =} \DecValTok{40}\NormalTok{), }
               \FunctionTok{rnorm}\NormalTok{(}\DecValTok{50}\NormalTok{, }\AttributeTok{mean =} \DecValTok{400}\NormalTok{, }\AttributeTok{sd =} \DecValTok{60}\NormalTok{)) }\CommentTok{\# Biomassa}
\NormalTok{)}

\CommentTok{\# Gráfico 3D condicional}
\FunctionTok{cloud}\NormalTok{(Biomassa }\SpecialCharTok{\textasciitilde{}}\NormalTok{ DAP }\SpecialCharTok{*}\NormalTok{ Altura }\SpecialCharTok{|}\NormalTok{ Parcela, }\AttributeTok{data =}\NormalTok{ dados,}
      \AttributeTok{main =} \StringTok{"Relação 3D: Biomassa, DAP e Altura por Parcela"}\NormalTok{,}
      \AttributeTok{xlab =} \StringTok{"Diâmetro (DAP)"}\NormalTok{,}
      \AttributeTok{ylab =} \StringTok{"Altura (m)"}\NormalTok{,}
      \AttributeTok{zlab =} \StringTok{"Biomassa (kg)"}\NormalTok{,}
      \AttributeTok{screen =} \FunctionTok{list}\NormalTok{(}\AttributeTok{z =} \DecValTok{60}\NormalTok{, }\AttributeTok{x =} \SpecialCharTok{{-}}\DecValTok{60}\NormalTok{),  }\CommentTok{\# Ajuste do ângulo de visualização}
      \AttributeTok{col =} \StringTok{"forestgreen"}\NormalTok{, }
      \AttributeTok{pch =} \DecValTok{16}\NormalTok{)  }\CommentTok{\# Pontos no gráfico}
\end{Highlighting}
\end{Shaded}

\includegraphics{Entre_Florestas_e_Dados_files/figure-latex/unnamed-chunk-65-1.pdf}

\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{library}\NormalTok{(lattice)}

\CommentTok{\# Gerando coordenadas x e y (grid regular)}
\NormalTok{x }\OtherTok{\textless{}{-}} \FunctionTok{seq}\NormalTok{(}\SpecialCharTok{{-}}\DecValTok{10}\NormalTok{, }\DecValTok{10}\NormalTok{, }\AttributeTok{length =} \DecValTok{30}\NormalTok{)  }\CommentTok{\# 30 pontos no eixo X}
\NormalTok{y }\OtherTok{\textless{}{-}} \FunctionTok{seq}\NormalTok{(}\SpecialCharTok{{-}}\DecValTok{10}\NormalTok{, }\DecValTok{10}\NormalTok{, }\AttributeTok{length =} \DecValTok{30}\NormalTok{)  }\CommentTok{\# 30 pontos no eixo Y}

\CommentTok{\# Gerando altura (z) com base em uma função para criar uma superfície}
\NormalTok{z }\OtherTok{\textless{}{-}} \FunctionTok{outer}\NormalTok{(x, y, }\ControlFlowTok{function}\NormalTok{(x, y) x }\SpecialCharTok{*} \DecValTok{2}\NormalTok{)}

\CommentTok{\# Convertendo para um data frame para usar com cloud()}
\NormalTok{dados }\OtherTok{\textless{}{-}} \FunctionTok{expand.grid}\NormalTok{(}\AttributeTok{x =}\NormalTok{ x, }\AttributeTok{y =}\NormalTok{ y)}
\NormalTok{dados}\SpecialCharTok{$}\NormalTok{z }\OtherTok{\textless{}{-}} \FunctionTok{as.vector}\NormalTok{(z)}

\CommentTok{\# Gráfico 3D simulando o terreno}
\FunctionTok{cloud}\NormalTok{(z }\SpecialCharTok{\textasciitilde{}}\NormalTok{ x }\SpecialCharTok{*}\NormalTok{ y, }\AttributeTok{data =}\NormalTok{ dados,}
      \AttributeTok{main =} \StringTok{"Terreno Simulado em 3D"}\NormalTok{,}
      \AttributeTok{xlab =} \StringTok{"Coordenada X"}\NormalTok{,}
      \AttributeTok{ylab =} \StringTok{"Coordenada Y"}\NormalTok{,}
      \AttributeTok{zlab =} \StringTok{"Altura (Z)"}\NormalTok{,}
      \AttributeTok{screen =} \FunctionTok{list}\NormalTok{(}\AttributeTok{z =} \DecValTok{60}\NormalTok{, }\AttributeTok{x =} \SpecialCharTok{{-}}\DecValTok{60}\NormalTok{),  }\CommentTok{\# Ângulo de visualização}
      \AttributeTok{col =} \StringTok{"lightblue"}\NormalTok{,              }\CommentTok{\# Cor dos pontos}
      \AttributeTok{panel.3d.cloud =}\NormalTok{ panel}\FloatTok{.3}\NormalTok{dscatter, }\CommentTok{\# Adiciona pontos ao gráfico}
      \AttributeTok{pch =} \DecValTok{16}\NormalTok{)                       }\CommentTok{\# Pontos sólidos}
\end{Highlighting}
\end{Shaded}

\includegraphics{Entre_Florestas_e_Dados_files/figure-latex/unnamed-chunk-66-1.pdf}

\subsection{Densidade Condicional}\label{densidade-condicional}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# Gerando dados simulados com a variável Especie}
\FunctionTok{set.seed}\NormalTok{(}\DecValTok{123}\NormalTok{)}
\NormalTok{dados }\OtherTok{\textless{}{-}} \FunctionTok{data.frame}\NormalTok{(}
  \AttributeTok{Altura =} \FunctionTok{c}\NormalTok{(}\FunctionTok{rnorm}\NormalTok{(}\DecValTok{50}\NormalTok{, }\AttributeTok{mean =} \DecValTok{15}\NormalTok{, }\AttributeTok{sd =} \DecValTok{3}\NormalTok{), }
             \FunctionTok{rnorm}\NormalTok{(}\DecValTok{50}\NormalTok{, }\AttributeTok{mean =} \DecValTok{18}\NormalTok{, }\AttributeTok{sd =} \DecValTok{2}\NormalTok{), }
             \FunctionTok{rnorm}\NormalTok{(}\DecValTok{50}\NormalTok{, }\AttributeTok{mean =} \DecValTok{20}\NormalTok{, }\AttributeTok{sd =} \DecValTok{4}\NormalTok{)),}
  \AttributeTok{Especie =} \FunctionTok{factor}\NormalTok{(}\FunctionTok{rep}\NormalTok{(}\FunctionTok{c}\NormalTok{(}\StringTok{"Espécie A"}\NormalTok{, }\StringTok{"Espécie B"}\NormalTok{, }\StringTok{"Espécie C"}\NormalTok{), }\AttributeTok{each =} \DecValTok{50}\NormalTok{))}
\NormalTok{)}


\CommentTok{\# Gráfico de densidade}
\FunctionTok{densityplot}\NormalTok{(}\SpecialCharTok{\textasciitilde{}}\NormalTok{ Altura }\SpecialCharTok{|}\NormalTok{ Especie, }\AttributeTok{data =}\NormalTok{ dados,}
            \AttributeTok{main =} \StringTok{"Densidade da Altura por Espécie"}\NormalTok{,}
            \AttributeTok{xlab =} \StringTok{"Altura (m)"}\NormalTok{,}
            \AttributeTok{plot.points =} \ConstantTok{FALSE}\NormalTok{, }\CommentTok{\# Ocultar pontos individuais}
            \AttributeTok{col =} \FunctionTok{c}\NormalTok{(}\StringTok{"blue"}\NormalTok{, }\StringTok{"darkgreen"}\NormalTok{, }\StringTok{"orange"}\NormalTok{))}
\end{Highlighting}
\end{Shaded}

\includegraphics{Entre_Florestas_e_Dados_files/figure-latex/unnamed-chunk-67-1.pdf}

\subsection{Matrix de dispersão (Scatterplot Matrix)}\label{matrix-de-dispersuxe3o-scatterplot-matrix}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# Gerando os dados simulados com DAP e Altura}
\FunctionTok{set.seed}\NormalTok{(}\DecValTok{123}\NormalTok{)}
\NormalTok{dados }\OtherTok{\textless{}{-}} \FunctionTok{data.frame}\NormalTok{(}
  \AttributeTok{DAP =} \FunctionTok{c}\NormalTok{(}\FunctionTok{rnorm}\NormalTok{(}\DecValTok{50}\NormalTok{, }\AttributeTok{mean =} \DecValTok{20}\NormalTok{, }\AttributeTok{sd =} \DecValTok{5}\NormalTok{), }
          \FunctionTok{rnorm}\NormalTok{(}\DecValTok{50}\NormalTok{, }\AttributeTok{mean =} \DecValTok{25}\NormalTok{, }\AttributeTok{sd =} \DecValTok{6}\NormalTok{), }
          \FunctionTok{rnorm}\NormalTok{(}\DecValTok{50}\NormalTok{, }\AttributeTok{mean =} \DecValTok{30}\NormalTok{, }\AttributeTok{sd =} \DecValTok{4}\NormalTok{)),}
  \AttributeTok{Altura =} \FunctionTok{c}\NormalTok{(}\FunctionTok{rnorm}\NormalTok{(}\DecValTok{50}\NormalTok{, }\AttributeTok{mean =} \DecValTok{15}\NormalTok{, }\AttributeTok{sd =} \DecValTok{3}\NormalTok{), }
             \FunctionTok{rnorm}\NormalTok{(}\DecValTok{50}\NormalTok{, }\AttributeTok{mean =} \DecValTok{18}\NormalTok{, }\AttributeTok{sd =} \DecValTok{2}\NormalTok{), }
             \FunctionTok{rnorm}\NormalTok{(}\DecValTok{50}\NormalTok{, }\AttributeTok{mean =} \DecValTok{20}\NormalTok{, }\AttributeTok{sd =} \DecValTok{4}\NormalTok{))}
\NormalTok{)}

\CommentTok{\# Calculando a biomassa}
\NormalTok{dados}\SpecialCharTok{$}\NormalTok{Biomassa }\OtherTok{\textless{}{-}}\NormalTok{ dados}\SpecialCharTok{$}\NormalTok{DAP }\SpecialCharTok{*}\NormalTok{ dados}\SpecialCharTok{$}\NormalTok{Altura }\SpecialCharTok{*} \FunctionTok{rnorm}\NormalTok{(}\DecValTok{150}\NormalTok{, }\AttributeTok{mean =} \FloatTok{0.1}\NormalTok{, }\AttributeTok{sd =} \FloatTok{0.01}\NormalTok{)}

\CommentTok{\# Gerando o scatterplot matrix (splom)}
\FunctionTok{library}\NormalTok{(lattice)}
\FunctionTok{splom}\NormalTok{(}\SpecialCharTok{\textasciitilde{}}\NormalTok{ dados[}\FunctionTok{c}\NormalTok{(}\StringTok{"DAP"}\NormalTok{, }\StringTok{"Altura"}\NormalTok{, }\StringTok{"Biomassa"}\NormalTok{)],}
      \AttributeTok{main =} \StringTok{"Matriz de Dispersão"}\NormalTok{,}
      \AttributeTok{col =} \StringTok{"darkblue"}\NormalTok{, }\AttributeTok{pch =} \DecValTok{16}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\includegraphics{Entre_Florestas_e_Dados_files/figure-latex/unnamed-chunk-68-1.pdf}

\subsection{Temporal condicional}\label{temporal-condicional}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# Dados simulados de crescimento anual}
\FunctionTok{set.seed}\NormalTok{(}\DecValTok{123}\NormalTok{)}
\NormalTok{anos }\OtherTok{\textless{}{-}} \DecValTok{2000}\SpecialCharTok{:}\DecValTok{2020}
\NormalTok{crescimento }\OtherTok{\textless{}{-}} \FunctionTok{expand.grid}\NormalTok{(}\AttributeTok{Ano =}\NormalTok{ anos, }\AttributeTok{Especie =} \FunctionTok{c}\NormalTok{(}\StringTok{"Espécie A"}\NormalTok{, }\StringTok{"Espécie B"}\NormalTok{, }\StringTok{"Espécie C"}\NormalTok{))}
\NormalTok{crescimento}\SpecialCharTok{$}\NormalTok{Altura }\OtherTok{\textless{}{-}} \FunctionTok{with}\NormalTok{(crescimento, }\FunctionTok{ifelse}\NormalTok{(Especie }\SpecialCharTok{==} \StringTok{"Espécie A"}\NormalTok{, }
                                               \FunctionTok{rnorm}\NormalTok{(}\FunctionTok{length}\NormalTok{(Ano), }\AttributeTok{mean =}\NormalTok{ Ano }\SpecialCharTok{{-}} \DecValTok{1995}\NormalTok{, }\AttributeTok{sd =} \FloatTok{0.5}\NormalTok{),}
                                               \FunctionTok{ifelse}\NormalTok{(Especie }\SpecialCharTok{==} \StringTok{"Espécie B"}\NormalTok{, }
                                                      \FunctionTok{rnorm}\NormalTok{(}\FunctionTok{length}\NormalTok{(Ano), }\AttributeTok{mean =}\NormalTok{ Ano }\SpecialCharTok{{-}} \DecValTok{1993}\NormalTok{, }\AttributeTok{sd =} \FloatTok{0.7}\NormalTok{),}
                                                      \FunctionTok{rnorm}\NormalTok{(}\FunctionTok{length}\NormalTok{(Ano), }\AttributeTok{mean =}\NormalTok{ Ano }\SpecialCharTok{{-}} \DecValTok{1990}\NormalTok{, }\AttributeTok{sd =} \FloatTok{0.6}\NormalTok{))))}

\CommentTok{\# Gráfico de linha com painéis}
\FunctionTok{xyplot}\NormalTok{(Altura }\SpecialCharTok{\textasciitilde{}}\NormalTok{ Ano }\SpecialCharTok{|}\NormalTok{ Especie, }\AttributeTok{data =}\NormalTok{ crescimento,}
       \AttributeTok{type =} \StringTok{"o"}\NormalTok{, }\AttributeTok{col =} \StringTok{"darkgreen"}\NormalTok{, }\AttributeTok{pch =} \DecValTok{16}\NormalTok{,}
       \AttributeTok{main =} \StringTok{"Crescimento por Espécie ao Longo dos Anos"}\NormalTok{,}
       \AttributeTok{xlab =} \StringTok{"Ano"}\NormalTok{, }\AttributeTok{ylab =} \StringTok{"Altura (m)"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\includegraphics{Entre_Florestas_e_Dados_files/figure-latex/unnamed-chunk-69-1.pdf}
...
\includegraphics{Entre_Florestas_e_Dados_files/figure-latex/unnamed-chunk-71-1.pdf}
...
\includegraphics{Entre_Florestas_e_Dados_files/figure-latex/unnamed-chunk-72-1.pdf}
...
\includegraphics{Entre_Florestas_e_Dados_files/figure-latex/unnamed-chunk-75-1.pdf}
...
\includegraphics{Entre_Florestas_e_Dados_files/figure-latex/unnamed-chunk-76-1.pdf}
...
\includegraphics{Entre_Florestas_e_Dados_files/figure-latex/unnamed-chunk-77-1.pdf}
...
\section{Processo em Conglomerados (Teoria)}\label{processo-em-conglomerados-teoria}

\subsection{Média da população}\label{muxe9dia-da-populauxe7uxe3o}

\[\bar{x} = \frac{\sum_{i=1}^n \sum_{j=1}^m \left( x_{ij} \right)}{n \cdot m}\]

\subsection{Média por subunidadae}\label{muxe9dia-por-subunidadae}

\[\bar{x}_i = \frac{\sum_{j=1}^m x_{ij}}{m}\]

\subsection{Variância total}\label{variuxe2ncia-total}

\[S_x^2 = S_e^2 + S_d^2\]

\subsection{Variância dentro do conglomerado}\label{variuxe2ncia-dentro-do-conglomerado}

\[S_d^2 = QM_{dentro} = \frac{\sum_{i=1}^n \sum_{j=1}^m \left( x_{ij} - \bar{x}_i \right)^2}{n \cdot (m - 1)}\]

\subsection{Variância entre conglomerados}\label{variuxe2ncia-entre-conglomerados}

\[QM_{entre} = \frac{\sum_{i=1}^n m \cdot \left( \bar{x}_i - \bar{x} \right)^2}{n - 1}\]

\subsection{Variância entre e dentro}\label{variuxe2ncia-entre-e-dentro}

\[S_e^2 = \frac{QM_{entre} - QM_{dentro}}{m}\]

\subsection{Coeficiente de correlação intraconglomerado}\label{coeficiente-de-correlauxe7uxe3o-intraconglomerado}

\[\rho = r = \frac{S_e^2}{S_e^2 + S_d^2}\]

\subsection{Intensidade amostral requerida}\label{intensidade-amostral-requerida}

\[n = \frac{t^2 \cdot S_x^2}{E^2 \cdot M} \cdot \left[ 1 + r \cdot (M - 1) \right]\]

\subsection{Variância total}\label{variuxe2ncia-total-1}

\[S_x^2 = S_e^2 + S_d^2\]

\subsection{Variância da média}\label{variuxe2ncia-da-muxe9dia}
...
\subsection{Erro padrão}\label{erro-padruxe3o}

\[S_{\bar{x}} = \sqrt{S_{\bar{x}}^2}\]

\subsection{Erro da amostragem absoluto}\label{erro-da-amostragem-absoluto}

\[S_{\bar{x}} = \sqrt{S_{\bar{x}}^2}\]

\subsection{Erro de amostragem relativo}\label{erro-de-amostragem-relativo}

\[E_r = \pm \frac{t \cdot S_{\bar{x}}}{\bar{x}} \cdot 100\]

\subsection{Intervalo de confiança para Média}\label{intervalo-de-confianuxe7a-para-muxe9dia}

\[IC\left[\bar{x} - (E_a) \leq \bar{x} \leq \bar{x} + (E_a)\right] = P\]

\subsection{Estimativa Total}\label{estimativa-total}

\[\hat{X} = N \cdot M \cdot \bar{x}\]

\subsection{Intervalo de confiança total}\label{intervalo-de-confianuxe7a-total}
...
\NormalTok{BD }\OtherTok{\textless{}{-}}\NormalTok{ BD[}\FunctionTok{order}\NormalTok{(BD}\SpecialCharTok{$}\NormalTok{Parc, BD}\SpecialCharTok{$}\NormalTok{DAP, }\AttributeTok{decreasing =} \ConstantTok{TRUE}\NormalTok{),]}
...
\NormalTok{Hdom\_assman }\OtherTok{\textless{}{-}} \FunctionTok{unique}\NormalTok{(BD}\SpecialCharTok{$}\NormalTok{Parc)}

\NormalTok{j }\OtherTok{\textless{}{-}} \DecValTok{1}
\ControlFlowTok{for}\NormalTok{ (i }\ControlFlowTok{in}\NormalTok{ Parc) \{}
\NormalTok{  a }\OtherTok{\textless{}{-}} \FunctionTok{ceiling}\NormalTok{(}\FunctionTok{mean}\NormalTok{(BD[}\FunctionTok{which}\NormalTok{(BD}\SpecialCharTok{$}\NormalTok{Parc}\SpecialCharTok{==}\NormalTok{i),}\DecValTok{1}\NormalTok{])}\SpecialCharTok{*}\DecValTok{100}\SpecialCharTok{/}\DecValTok{10000}\NormalTok{)}
...
\NormalTok{  Hdom\_assman[j] }\OtherTok{\textless{}{-}} \FunctionTok{round}\NormalTok{(}\FunctionTok{mean}\NormalTok{(H[}\DecValTok{1}\SpecialCharTok{:}\NormalTok{a]), }\DecValTok{2}\NormalTok{)}
\NormalTok{  j }\OtherTok{\textless{}{-}}\NormalTok{ j}\SpecialCharTok{+}\DecValTok{1}
\NormalTok{\}}

\NormalTok{BD2 }\OtherTok{\textless{}{-}} \FunctionTok{as.data.frame}\NormalTok{(}\FunctionTok{cbind}\NormalTok{(Parc, Hdom\_assman))}
...
\NormalTok{  Parc }\OtherTok{\textless{}{-}} \FunctionTok{unique}\NormalTok{(BD}\SpecialCharTok{$}\NormalTok{Parc)}
\NormalTok{  Hdom\_hart }\OtherTok{\textless{}{-}} \FunctionTok{unique}\NormalTok{(BD}\SpecialCharTok{$}\NormalTok{Parc)}
  
\NormalTok{  j }\OtherTok{\textless{}{-}} \DecValTok{1}
  \ControlFlowTok{for}\NormalTok{ (i }\ControlFlowTok{in}\NormalTok{ Parc) \{}
\NormalTok{    a }\OtherTok{\textless{}{-}} \FunctionTok{ceiling}\NormalTok{(}\FunctionTok{mean}\NormalTok{(BD[}\FunctionTok{which}\NormalTok{(BD}\SpecialCharTok{$}\NormalTok{Parc}\SpecialCharTok{==}\NormalTok{i),}\DecValTok{1}\NormalTok{])}\SpecialCharTok{*}\DecValTok{100}\SpecialCharTok{/}\DecValTok{10000}\NormalTok{)}
\NormalTok{    H }\OtherTok{\textless{}{-}}\NormalTok{ BD[}\FunctionTok{which}\NormalTok{(BD}\SpecialCharTok{$}\NormalTok{Parc}\SpecialCharTok{==}\NormalTok{i),}\DecValTok{5}\NormalTok{]}
\NormalTok{    Hdom\_hart[j] }\OtherTok{\textless{}{-}} \FunctionTok{round}\NormalTok{(}\FunctionTok{mean}\NormalTok{(H[}\DecValTok{1}\SpecialCharTok{:}\NormalTok{a]), }\DecValTok{2}\NormalTok{)}
\NormalTok{    j }\OtherTok{\textless{}{-}}\NormalTok{ j}\SpecialCharTok{+}\DecValTok{1}
\NormalTok{  \}}
  
\NormalTok{  BD2 }\OtherTok{\textless{}{-}} \FunctionTok{as.data.frame}\NormalTok{(}\FunctionTok{cbind}\NormalTok{(Parc, Hdom\_hart))}
\NormalTok{  BD }\OtherTok{\textless{}{-}} \FunctionTok{merge}\NormalTok{(BD, BD2)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{  BD }\OtherTok{\textless{}{-}}\NormalTok{ BD }\SpecialCharTok{\%\textgreater{}\%}
    \FunctionTok{arrange}\NormalTok{(Parc, }\FunctionTok{desc}\NormalTok{(Ht))  }\CommentTok{\# Garantir a ordem correta}
  
\NormalTok{  BD\_Hart }\OtherTok{\textless{}{-}}\NormalTok{ BD }\SpecialCharTok{\%\textgreater{}\%}
    \FunctionTok{group\_by}\NormalTok{(Parc) }\SpecialCharTok{\%\textgreater{}\%}
    \FunctionTok{mutate}\NormalTok{(}
      \AttributeTok{num\_top =} \FunctionTok{ceiling}\NormalTok{(}\FunctionTok{mean}\NormalTok{(areaParc) }\SpecialCharTok{*} \DecValTok{100} \SpecialCharTok{/} \DecValTok{10000}\NormalTok{)}
\NormalTok{    ) }\SpecialCharTok{\%\textgreater{}\%}
    \FunctionTok{slice}\NormalTok{(}\DecValTok{1}\SpecialCharTok{:}\FunctionTok{first}\NormalTok{(num\_top)) }\SpecialCharTok{\%\textgreater{}\%}
    \FunctionTok{summarise}\NormalTok{(}
      \AttributeTok{Hdom\_Hart2 =} \FunctionTok{round}\NormalTok{(}\FunctionTok{mean}\NormalTok{(Ht, }\AttributeTok{na.rm =} \ConstantTok{TRUE}\NormalTok{), }\DecValTok{2}\NormalTok{)}
\NormalTok{    ) }\SpecialCharTok{\%\textgreater{}\%}
    \FunctionTok{ungroup}\NormalTok{()}
  
\NormalTok{  BD\_HDOM }\OtherTok{\textless{}{-}} \FunctionTok{merge}\NormalTok{(BD2, BD\_Hart, }\AttributeTok{by =} \StringTok{"Parc"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
